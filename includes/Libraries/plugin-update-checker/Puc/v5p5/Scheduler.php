    ...
    class Scheduler {
        ...
        public function __construct(
            ...
            if ($this->checkPeriod > 0) {
                ...
                add_action('upgrader_process_complete', [$this, 'removeHooksIfLibraryGone'], 1, 0);
        ...
        protected function getEffectiveCheckPeriod() {
            ...
            if (in_array($currentFilter, ['load-update-core.php', 'upgrader_process_complete'])) {
                ...
                $this->throttleRedundantChecks &&
                $this->updateChecker->getUpdate() !== null
            ) {

    ...
    abstract class UpdateChecker {
        ...
        public function __construct(
            ...
            if ($this->wpCliCheckTrigger === null && defined('WP_CLI')) {
                $this->wpCliCheckTrigger = new WpCliCheckTrigger(
                    $this->componentType,
                    $this->scheduler
                );
            }
        ...
        protected function installHooks() {
            ...
            add_filter('site_transient_' . $this->updateTransient, [
                $this,
            ...
            add_filter('http_request_args', [$this, 'excludeEntityFromWordPressAPI'], 10, 2);
        ...
        public function removeHooks() {
            ...
            remove_filter('site_transient_' . $this->updateTransient, [
                $this,
                'injectTranslationUpdates',
            ]);
            ...
            remove_filter('http_request_args', [$this, 'excludeEntityFromWordPressAPI']);
        ...
        public function excludeEntityFromWordPressAPI($args, $url) {
            ...
            if (
                ...
                strtolower($parsedUrl['host']) !== 'api.wordpress.org'
            ) {
                return $args;
            }
            ...
            if (
                ...
                !Utils::startsWith($parsedUrl['path'], $expectedPathPrefix)
            ) {
                return $args;
            }
        ...
        protected function filterUpdateResult($update, $httpResult = null) {
            ...
            $update = apply_filters(
                $this->getUniqueName('request_update_result'),
                $update,
                $httpResult
            );
        ...
        protected function addNoUpdateItem($updates) {
            ...
            $updates->no_update[
                $this->getUpdateListKey()
            ] = (object) $this->getNoUpdateItemFields();
        ...
        protected function requestMetadata($metaClass, $filterRoot, $queryArgs = []) {
            ...
            $result = apply_filters(
                $this->getUniqueName('request_metadata_http_result'),
                $result,
                $url,
                $options
            );
        ...
        protected function validateApiResponse($result) {
            if (is_wp_error($result)) {
                ...
                return new WP_Error(
                    ...
                    'WP HTTP Error: ' . $result->get_error_message()
                );
            }
            ...
            foreach ($translationUpdates as $update) {
                $convertedUpdate = array_merge(
                    [
                        ...
                        'version' => isset($update->version)
                            ? $update->version
                            : '1.' . strtotime($update->updated),
                    ],
                    (array) $update
                );

...
class FeedCronManager {
    ...
    public function prefetch_feeds() {
        ...
        $this->logger->info('Cron: Prefetching completed. Success: ' . $success_count . ', Errors: ' . $error_count);
    }
    ...
    public function process_cached_feeds() {
        ...
        $this->logger->info('Cron: Processing completed. Success: ' . $results['success'] . ', Errors: ' . $results['failed']);
